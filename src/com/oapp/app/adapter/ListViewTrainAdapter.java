...
public class ListViewTrainAdapter extends BaseAdapter {
	...
	private List<TBizBringupNoticeVO> 					listItems;//数据集合
	 ...
	 * @param resource
	 */
	public ListViewTrainAdapter(Context context, List<TBizBringupNoticeVO> data,int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		//设置文字和图片
		TBizBringupNoticeVO info = listItems.get(position);
		
		listItemView.title.setText(info.getTitle());
